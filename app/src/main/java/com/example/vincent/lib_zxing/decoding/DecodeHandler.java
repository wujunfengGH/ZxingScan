...
package com.example.vincent.lib_zxing.decoding;
...
import com.example.vincent.lib_zxing.camera.PlanarYUVLuminanceSource;
...
final class DecodeHandler extends Handler {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            Message message = Message.obtain(mActivity.getHandler(), R.id.decode_succeeded, rawResult);
