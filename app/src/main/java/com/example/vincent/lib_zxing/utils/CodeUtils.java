package com.example.vincent.lib_zxing.utils;
...
import com.example.vincent.lib_zxing.camera.BitmapLuminanceSource;
import com.example.vincent.lib_zxing.camera.CameraManager;
import com.example.vincent.lib_zxing.decoding.DecodeFormatManager;
...
//        Bitmap mBitmap = BitmapFactory.decodeFile(path, options);
    ...
    public static void setLightEnable(boolean isEnable) {
        if (isEnable) {
